...
// same code  as assignRoomNumberbut it will locate us to reviewBookings.php, so we stay on the same page after completing the form
...
if (($room_type == 'twin' && $room_number >= 1 && $room_number <= 10) ||
  ...
  header("location: reviewBookings.php?error=Invalid room number. Use: 1-10 - TWIN, 11-20 - DOUBLE, 21-30 - DELUXE.");
}
?>
